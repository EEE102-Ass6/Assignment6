...
////////////////////////////////////////////设置邮件信息/////////////////////////////////////////////////////////////////////
void Send_mail::setServerName(const std::string server_name)        //smtp服务器地址    
{
    m_ServerName=server_name;
}

void Send_mail::setUserName(const std::string user_name)            //邮箱用户名
{
    m_UserName=user_name;
}

void Send_mail::setUserPwd(const std::string user_pwd)                //邮箱用户密码
{
    m_UserPwd=user_pwd;
}

void Send_mail::setSenderName(const std::string sender_name)        //发送者的名字
{
    m_SenderName=sender_name;
}

void Send_mail::setSenderAddress(const std::string sender_addr)    //发送者的邮箱(mail form:)
{
...
void Send_mail::AddFilePath(std::string szFilePath)//添加附件路径  
{  
...
void Send_mail::DeleteFilePath(std::string szFilePath)//删除附件路径  
{  
