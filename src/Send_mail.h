...
using namespace std;
//type def
const int MAX_BUFFER_SIZE = 255;                            //send&recievers' buffer_size
...
public:
	...
	/////////////////////////connent///////////////////////////////////
	void setServerName(const std::string server_name);        //smtp server address  
	void setUserName(const std::string user_name);            //e-mail user
	void setUserPwd(const std::string user_pwd);            //e-mail password
															/////////////////////////SendMail//////////////////////////////////
	void setSenderName(const std::string sender_name);        //sender name
	void setSenderAddress(const std::string sender_addr);    //sender's address

															 //reciever
	void setReceiver(const std::string name, const std::string address);            //add
	void addReceiver(const std::string name, const std::string address);            //reciever
	void clearReceiver();                                                            //clear buffers
